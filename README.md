...
alert("Bitte zuerst Spiel auswählen");
...
xgHome.innerHTML=
Number(xg[0]).toFixed(2);


xgAway.innerHTML=
Number(xg[1]).toFixed(2);





let pos=getPair("Ballbesitz");
